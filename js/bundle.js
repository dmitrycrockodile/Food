...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
   ...
   const slidiesField = document.querySelector(field);
   ...
   slidiesField.style.width = 100 * slides.length + '%';
   slidiesField.style.display = 'flex';
   slidiesField.style.transition = '0.5s all';
   ...
   next.addEventListener('click', () => {
      ...
      slidiesField.style.transform = `translateX(-${offset}px)`;
